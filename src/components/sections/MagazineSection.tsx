...
const MagazineSection = () => {
  ...
  return (
    <section id="magazine" className="relative w-full bg-white md:px-8 py-12 overflow-hidden">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10">
        <header className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <button
            ...
            className="self-start rounded-ee-2xl rounded-tl-2xl bg-[#333333] px-16 py-3 text-xl font-semibold text-white shadow-md transition hover:bg-[#333333]"
          >
            Read More
